const VERSION="1.0.3";const CACHE="casino-cache-"+VERSION;const ASSETS=["./","./index.html?rev="+VERSION,"./manifest.json?rev="+VERSION,"./icons/icon-192.png","./icons/icon-512.png"];
